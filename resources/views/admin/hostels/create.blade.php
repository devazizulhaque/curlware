            ...
            <div class="card-body basic-form">
                <form action="{{ route('hostels.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" class="form-control input-default" id="address" cols="30" rows="2"></textarea>
                        <input type="text" class="form-control input-default" id="address" name="address" placeholder="Enter address">
                    </div>
                    <div class="form-group row rowroom" style="position: relative">
                        ...
                        <div class="col-6">
                            ...
                            <small>
                                ...
                                @endforeach
                                @endif
                            <input type="text" class="form-control input-default" id="totalroom" name="totalroom[]" placeholder="Enter Total Room">
                        </div>
