    ...
    <div id="main-wrapper">
            ...
            <div class="header-content">
                        ...
                        <ul class="navbar-nav header-right main-notification">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{ asset('/') }}admin/assets/images/avatar/3.jpg" width="20" alt="">
				...
				<div class="sub-header">
					<div class="d-flex align-items-center flex-wrap mr-auto">
						<h5 class="dashboard_bar">@yield('page-header')</h5>
					</div>
					<div class="d-flex align-items-center">
                        <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1" id="todayBtn">Today</a>
                        <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1" id="monthBtn">Month</a>
                        <a href="javascript:void(0);" class="btn btn-xs btn-primary light" id="yearBtn">Year</a>
                    </div>
				</div>
			</div>
        </div>
        ...
        ***********************************-->
        ...
        <script>
            ...
            document.getElementById('todayBtn').textContent = 'Today: ' + formattedDate;
    
            var monthNames = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
            document.getElementById('monthBtn').textContent = 'Month: ' + monthNames[currentDate.getMonth()];
            document.getElementById('yearBtn').textContent = 'Year: ' + currentDate.getFullYear();
        </script>